...
//Добавлены/изменены строки js: 20,25,26,212; html: 11

//2. Генерировать временные препятствия на поле.
//Добавлены/изменены строки css: 36-38; js: 84, 174-177, 233, 245-300

//3. *Убрать границы поля. Т.е. при пересечении границы поля змейка появляется с противоположной стороны.
//Добавлены/изменены строки js: 126-151
...
////////////////////// Проверка и создание препятствия
